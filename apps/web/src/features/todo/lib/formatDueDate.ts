export function normalizeDueDate(value: string | null | undefined): string {
  if (!value) return "";
...
export function normalizeDueTime(value: string | null | undefined): string {
  if (!value) return "";
...
export function combineDueParts(
  dueDate: string | null | undefined,
  dueTime?: string | null | undefined,
): string | null {
  const date = normalizeDueDate(dueDate);

...
## 프론트 아키텍처 연계 규칙
- 프론트는 페이지에서 네트워크 호출을 직접 수행하지 않고 기능 훅/유스케이스 경유를 기본으로 한다.
- 프론트 구조/렌더링 안정성 규칙은 아래 문서를 단일 기준으로 따른다.
- `docs/400-시스템-아키텍처.md`의 "프론트엔드 구조 운영 규칙"
- `docs/420-플랫폼-기술선정.md`의 "Web 렌더링 안정성 규칙 (Next.js)"
- API 변경 시 Web/Desktop/Mobile 소비 경로를 함께 점검한다.
